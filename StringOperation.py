...
class StringOperation:
    ...
    def __init__(self):
        ...
        self.city_list = ['札幌', '函館', '小樽', '旭川', '室蘭', '釧路', '帯広',
                          ...
                          '竹富', '与那国']
        self.language = ["Java", "C", "C++", "C＃", "PHP", "Ruby", "Python2", "Python3", "Perl", "Objective-C", "Swift", "Visual Basic(VB.NET)", "ActionScript", "R言語", "Groovy", "Haskell", "Scala", "Erlang", "Go言語", "JavaScript", "HTML5+CSS3", "HTML+CSS", "CoffeeScript", "Haml",
        ...
        self.framework = ["Struts", "Seasar2", "JSF", "Spring", "Hibernate", "iBATIS", "MyBatis", "Java EE", "Play Framework", "Symfony", "CakePHP", "CodeIgniter", "FuelPHP", "Zend Framework", "Ethna", "Smarty", "Laravel", "Phalcon", "Slim", "Ruby on Rails", "Sinatra", "Camping", "Catalyst", "Waves", "Django", "Tornado", "Flask", "Pyramid", "Pylons", "Unity", "ngCore", "Unreal Engine", "cocos2d",
                          "cocos2d-x", ".NET Framework", "DirectX", "OpenGL", "Android SDK", "iOS SDK", "jQuery", "Angular", "React", "React Native", "Vue.js", "prototype.js", "Node.js", "Backbone.js", "Ember.js", "Knockout.js", "Riot.js", "Bootstrap", "Foundation", "Dojo Toolkit", "Titanium Mobile", "Echo", "Gin", "Revel", "TensorFlow", "Chainer", "Caffe", "Express", "Flutter", "Xamarin", "Next.js", "Nuxt.js", "actix-web"]
        self.position = ['主任','係長','課長','次長','部長','本部長','常務取締役','事業部長','専務取締役','代表取締役社長']
        self.stop_word = ['関連','UNIT','処理','プリセールス','社員','スマホアプリ','LAMP','VPOE','分析','CMS','リモート','GRAM','翻訳','コア','現場','区','プラットフォーム','BPM','グループ','5','COCOS','エンジニアリング','コンサルティング','PDM','バトル','主幹','イン','スマートフォンアプリ','バーチャル','候補','ファームウェア','保守','性','情報','ポテンシャル','募集','コトダマン','ソフト','QA','GO','PJM','推進','サウンド','ネイティブ','・','課','知識','移行','DEVOPS','戦略','エンジニアオープンポジション','ERP','LINE','者','役職','キャリアアップコース','構築','パワー','カゴ','★','将来','検査','SAAS','ストレージ','量子','大手','DRUPAL','空間','アクション','サポート','設計','中心経験','メイン','6','テクニカル','ミドル','管理','フルリモートエンジニア','工場','GUI','立','コース','2','端末','チーム','グラフィックス','ORACLE','ECU','落','外観','LS','SSP','画像','幹部','高速','小倉北','VB','AP基盤','アプリ分析','認証','プログラミング','365','FPGA','初級','HEAD','RELIABILITY','経験','受託','線','オンプレ','プラント','キャッシュレスサービズ','職','認可','MICROSOFT','モール','企業','ソリューション','診断','上','社会','配信','歓迎','SENSOR','運','装置','DICOM','工程','部','ES','3','効率','オフィス','SAP','NVME','仕事','モバイル','NET','JAVA','パッケージ','ユーザー','SITE','コンクリート','DCG','AWS','SMARTPHONE','可能','付','正社員','LINUX','WIN','グロース','技術','認識','物体','ソース','候補ANDROID','IOS分析分析分析','スマホアフ','MOBILE','肩書','検出','以上','検討','オープン','車載','都内','兼','クライアントサービス','自動','ポジション','IOS','ジュニア','実践','上級','有','OPEN','月','電子','合計','研究','系基盤','電気','アルゴリズム','ツール','マネー','SSD','保証','システム','ロボット','DYNAMICS','セールス','TIPSTAR','担当','契約','本社','基盤','ミニアプリ','業務','ANDROIDIOS','連携','時','社','モバイルアプリ','先端','年','アジャイル','実現','制作','エンタープライズソリューション','ANDOROID','統合','環境','研修','新規','保守VPOE','EC','導入','勤務','アプリ・','最適','脆弱','メール','基盤','支援','言語','講師','PEP','採用','系','可','医薬','領域','教室','アプリ','ニア','戦力','決済','運転','自社分析','候補候補','向','技師','内','メンター','ソフトウェア','市','深層','サイト','レス','治験','NW','企画','ビッグ基盤','優遇','実務','キャッシュ','上流','MIS','RAILS','部門','解析','遊技','品質','トレイン','RPA','製','創出','リガー','API','刷新','適正','責任','専任','運用','拠点','HR','ON','機','SS','保険','大手商','担当','CRM','100','物流','自動車','次世代','主席','自社','マーケティング','数理','基幹','モビリティ','クラス','1','用保守','UP','映像','PYTHON','カルテ','ANDROID','SALESFORCE','MS','SHUFOO','リエンシ','運営','等','MLOPS','方','アウト','事業','若手','X','ランク','メッセージ','SDK','SHUTTO','教育','D','化','関連','UNIT','処理','プリセールス','社員','スマホアプリ','LAMP','VPOE','分析','CMS','リモート','GRAM','翻訳','コア','現場','区','プラットフォーム','BPM','グループ','5','COCOS','エンジニアリング','コンサルティング','PDM','バトル','主幹','イン','スマートフォンアプリ','バーチャル','候補','ファームウェア','保守','性','情報','ポテンシャル','募集','コトダマン','ソフト','QA','GO','PJM','推進','サウンド','ネイティブ','・','課','知識','移行','DEVOPS','戦略','エンジニアオープンポジション','ERP','LINE','者','役職','キャリアアップコース','構築','パワー','カゴ','★','将来','検査','SAAS','ストレージ','量子','大手','DRUPAL','空間','アクション','サポート','設計','中心経験','メイン','6','テクニカル','ミドル','管理','フルリモートエンジニア','工場','GUI','立','コース','2','端末','チーム','グラフィックス','ORACLE','ECU','落','外観','LS','SSP','画像','幹部','高速','小倉北','VB','AP基盤','アプリ分析','認証','プログラミング','365','FPGA','初級','HEAD','RELIABILITY','経験','受託','線','オンプレ','プラント','キャッシュレスサービズ','職','認可','MICROSOFT','モール','企業','ソリューション','診断','上','社会','配信','歓迎','SENSOR','運','装置','DICOM','工程','部','ES','3','効率','オフィス','SAP','NVME','仕事','モバイル','NET','JAVA','パッケージ','ユーザー','SITE','コンクリート','DCG','AWS','SMARTPHONE','可能','付','正社員','LINUX','WIN','グロース','技術','認識','物体','ソース','候補','IOS','分析','スマホアフ','MOBILE','肩書','検出','以上','検討','オープン','車載','都内','兼','クライアントサービス','自動','ポジション','IOS','ジュニア','実践','上級','有','OPEN','月','電子','合計','研究','系基盤','電気','アルゴリズム','ツール','マネー','SSD','保証','システム','ロボット','DYNAMICS','セールス','TIPSTAR','分析','契約','本社','基盤','ミニアプリ','業務','ANDROIDIOS','連携','時','社','モバイルアプリ','先端','年','アジャイル','実現','制作','エンタープライズソリューション','ANDOROID','統合','環境','研修','新規','保守VPOE','EC','導入','勤務','アプリ・','最適','脆弱','メール','候補','支援','言語','講師','PEP','採用','系','可','医薬','領域','教室','アプリ','ニア','戦力','決済','運転','自社分析','候補候補','向','技師','内','メンター','ソフトウェア','市','深層','サイト','レス','治験','NW','企画','ビッグ基盤','優遇','実務','キャッシュ','上流','MIS','RAILS','部門','解析','遊技','品質','トレイン','RPA','製','創出','リガー','API','刷新','適正','責任','専任','運用','拠点','HR','ON','機','SS','保険','大手商','担当','CRM','100','物流','自動車','次世代','主席','自社','マーケティング','数理','基幹','モビリティ','クラス','1','用保守','UP','映像','PYTHON','カルテ','ANDROID','SALESFORCE','MS','SHUFOO','リエンシ','運営','等','MLOPS','方','アウト','事業','若手','X','ランク','メッセージ','SDK','SHUTTO','教育','D','化']

        self.prefecture_list = self.get_unique_list(self.prefecture_list)
        self.region_list = self.get_unique_list(self.region_list)
        self.city_list = self.get_unique_list(self.city_list)
        self.language = self.get_unique_list(self.language)
        self.framework = self.get_unique_list(self.framework)
        self.position = self.get_unique_list(self.position)
        self.stop_word = self.get_unique_list(self.stop_word)
        return
