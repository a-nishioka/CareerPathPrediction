...
class StringOperation:
    ...
    def __init__(self):
        ...
        self.stop_word = ["CMS", "業務", "向け", "スタック", "採用", "IoT", "募集", "可能", "ECU", "付き", "品質", "SDK", "翻訳", "Devops", "ジュニア", "研究", "テスト", "知識", "スマホアプリ", "MLOps", "Shufoo", "方", "課", "最適", "導入", "運営", "Unity", "Iot", "デジタルマーケター", "可", "ランク", "上げ", "Oracle", "コトダマン", "マネー", "シニア", "ミドル", "解析", "バックエンドアプリ", "SS", "社会", "on", "候補", "保険", "空間", "数理", "化", "プロデューサー", "機", "プラットフォーム", "", "統合", "初級", "メンター", "・", "ネイティブ", "自社", "線", "企画", "パワー", "モバイル", "IBM", "Unit", "主任", "先端", "契約", "Python", "プリセールス", "オフィス", "イン", "Microsoft", "専任", "Linux", "DX", "ERP", "NET", "講師", "学習", "区", "LINE", "診断", "PjM", "3", "歓迎", "等", "ロボット", "パッケージ", "1", "配信", "治験", "創出", "ソリューション", "shutto", "スキル", "100", "画像", "OK", "バーチャル", "キャリアアップコース", "FPGA", "チーム", "部", "MIS", "検査", "マネジメント", "Rails", "クライアントサービス", "担当", "ツール", "勤務", "アソシエイト", "ポテンシャル", "Pep", "仕事", "キャッシュレスサービズ", "脆弱", "環境", "系", "内", "次世代", "Architect", "5", "Android", "保守", "関連", "上流", "Lead", "x", "Andoroid", "本社", "ルーキー", "オープン", "スマホアフ", "PHP", "コース", "支援", "データベース", "VB", "端末", "ソフト", "d", "基幹", "認証", "Win", "グロース", "上級", "PO", "決済", "保証", "戦略", "ユーザー", "ミニアプリ", "連携", "戦力", "物流", "車載", "教育", "兼", "★", "API", "構築", "量子", "ビッグ", "移行", "AI", "Site", "GUI", "用保守", "外観", "コンクリート", "年", "Up", "PdM", "情報", "運用", "製", "効率", "C", "課長", "優遇", "運", "都内", "X", "映像",
                          "メッセージ", "プログラミング", "立ち", "365", "ソース", "COBOL", "メンバー", "モビリティ", "AWS", "アジャイル", "コア", "グラフィックス", "大手", "ファームウェア", "工場", "受託", "Open", "性", "遊技", "Smartphone", "6", "Dynamics", "管理", "高速", "LAMP", "EC", "フルリモート", "推進", "深層", "ニア", "主席", "React", "Drupal", "設計", "社員", "チェンジ", "キャッシュ", "グループ", "アプリ・", "クラス", "落ち", "若手", "TIPSTAR", "VPoE", "MS", "gram", "ストレージ", "SaaS", "事業", "正社員", "Flutter", "DevOps", "自動車", "ため", "モール", "現場", "オンプレ", "カルテ", "Sensor", "レス", "実践", "BPM", "スマートフォンアプリ", "領域", "Go", "ES", "Head", "電気", "backcheck", "経験", "SSD", "分析", "コンサルティング", "新規", "博多", "テクニカルディレクション", "HR", "機械", "検討", "SSP", "役職", "サイト", "運転", "アルゴリズム", "サウンド", "アクション", "企業", "IOS", "者", "時", "2", "Reliability", "適正", "D", "JAVA", "Salesforce", "Ruby", "NVMe", "アウト", "刷新", "リエンシ", "認可", "Cocos", "SAP", "エンジニアオープンポジション", "係長", "エンタープライズソリューション", "物体", "大手商", "DCG", "処理", "RPA", "研修", "マーケティング", "Java", "リガー", "セールス", "医薬", "DICOM", "ゲーム", "基盤", "び", "agentbank", "LS", "幹部", "etc", "工程", "カゴ", "将来", "メール", "CRM", "制作", "か月", "肩書", "データマネジメントディレクター", "技師", "責任", "装置", "リモート", "部長", "実現", "バトル", "トレイン", "iOS", "技術", "以上", "モバイルアプリ", "小倉北", "mobile", "主幹", "市", "合計", "実務", "認識", "有", "社", "検出", "Kotlin", "IT", "教室", "電子", "拠点", "オーナー", "部門", "AP", "コーディネーター", "プラント", "自動", "職", "Tech", "エキスパート", "中心", "ポジション", "言語"]
        return
